...
JSON.stringify({
  ...
  marks: document.querySelectorAll(".docx-doc .pdf-page-break:not(.pdf-page-last)").length,
  ...
  startsWith: (() => {
    ...
    return [...document.querySelectorAll(".docx-doc .pdf-page-break:not(.pdf-page-last)")].map((m) => {
