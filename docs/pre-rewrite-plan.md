...
- **Category:** data-hygiene
- **Artifact:** `docs/pre-rewrite-plan.md:104-106` (the coupled deferrals; the "redb schema not yet built" blocker text is stale, the target SQL now exists at `docs/atproto-domain-model.md:209-316`); `docs/atproto-port.md:223-226` (step 2 greenlights the mapping); verified: zero backend-canonical serde types anywhere
