...
/// subscribes the caller to the scroll, which is how the page control follows
/// the reader without a listener of its own.
pub fn progress() -> i32 {
    PROGRESS()
}
...
/// A thin bar along the top saying how far through the page the reader has
/// scrolled. Orientation for a long document, and nothing to operate: moving to
/// a place in a paged document is the page control's job, which says what it is
/// and can be found.
#[component]
