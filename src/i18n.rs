...
const EN_JSON: &str = r#"{
    ...
    "game": {
        ...
        "controls": "Drive with ← → or A/D. Jump with ↑, W or Space. Hang a poster with ↓, E or Enter, once the board lights up pink.",
...
const DA_JSON: &str = r#"{
    ...
    "game": {
        ...
        "controls": "Kør med ← → eller A/D. Hop med ↑, W eller mellemrum. Hæng en plakat op med ↓, E eller Enter, når tavlen lyser pink.",
